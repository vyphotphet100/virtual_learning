				    	...
				    	<div class="col">
					    	<div class="header_content d-flex flex-row align-items-center justify-content-start">
						    	...
						    	<nav class="main_nav_contaner ml-auto">
								    ...
								    <div class="active shopping_cart " ><i><a href="#" class="fa fa-user-circle-o"></a></i></div>
        ...
        <div class="container rounded bg-white mt-5 mb-5"   >
            <div class="row">
                <div class="col-md-3 border-right">
                    <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" src="resources/images/comment_2.jpg" width="90"><span class="font-weight-bold">hunghtk456</span><span class="text-black-50">hunghtk456@gmail.com</span><span>United States</span></div>
                </div>
                <div class="col-md-5 border-right">
                    <div class="p-3 py-5">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12"><label class="labels">Email</label><input type="text" class="form-control" placeholder="Your email address" ></div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-6"><label class="labels">Phone</label><input type="text" class="form-control"  placeholder="Your phone"></div>
                        </div>
                        <div class="mb-3">
                ...
                <div class="col-md-4">
                    <div class="p-3 py-5">
                        ...
                        <div class="d-flex flex-row mt-3 exp-container"><img src="https://eitrawmaterials.eu/wp-content/uploads/2016/07/twitter.png" width="45" height="45">
                            <div class="work-experience ml-1"><span class="font-weight-bold d-block"></span><span class="d-block text-black-50 labels">Twitter Inc.</div>
                        </div>
                        <hr>
                        <div class="d-flex flex-row mt-3 exp-container"><img src="https://img.icons8.com/color/100/000000/facebook.png" width="45" height="45">
                            <div class="work-experience ml-1"><span class="font-weight-bold d-block"></span><span class="d-block text-black-50 labels">Facebook Inc.</span></div>
                        </div>
                        <hr>
                        <div class="d-flex flex-row mt-3 exp-container"><img src="https://img.icons8.com/color/50/000000/google-logo.png" width="45" height="45">
                            <div class="work-experience ml-1"><span class="font-weight-bold d-block"></span><span class="d-block text-black-50 labels">Google Inc.</span></div>
                        </div>
                    </div>
                </div>
            </div>
