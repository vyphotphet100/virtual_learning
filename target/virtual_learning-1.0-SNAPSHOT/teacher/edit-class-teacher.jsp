...
<div class="courses">
    ...
    <!--Form add class-->
    <form class="login100-form validate-form edit-form" method="post" id="edit-class">
        ...
        <div class="wrap-input100 validate-input description" data-validate="Description is required">
            <textarea class="input100 has-val" type="text" name="description">${clazz.description}</textarea>
            <span class="focus-input100"></span>
    ...
    <div class="text-center">
        <a href="#" class="a-join-button">
            <button type="submit" class="join-button" form="edit-class">
                <b>Apply</b>
            </button>
        </a>
    </div>
