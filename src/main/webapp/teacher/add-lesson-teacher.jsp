...
<div class="courses">
    ...
    <form class="login100-form validate-form edit-form" id="class-form">
        ...
        <div class="wrap-input100 validate-input" data-validate="Name of lesson is required">
            <input class="input100 has-val" type="text" name="title" value="">
        ...
        <div class="text-center">
            ...
            <textarea id="editLink" name="video" form="class-form"
                      style="background-color: #f9fafc;"></textarea>
        </div>

        <h3 class="text-center" style="margin-bottom: 20px; margin-top: 50px;">Question?</h3>
<%--        <div class="question-form-container">--%>
<%--            <div class="text-center edit-question-form" id="question-overview-1">--%>
                    ...
                    <div class="modal-body">
                        <div class="question-content">
                            ...
                            <textarea id="modalDescriptionInput"
                                      class="question-input description"></textarea>
